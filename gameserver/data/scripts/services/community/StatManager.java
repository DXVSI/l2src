...
/**
 * @author KilRoy
 * Community Board v2.0 Stats (PK/PVP kills) MOD
 */
public class StatManager implements ScriptFile, ICommunityBoardHandler
{
	...
	public void onLoad()
	{
		if(Config.BBS_PVP_STATS_ENABLED && Config.BBS_PVP_CB_ENABLED)
		{
			_log.info("CommunityBoard: Manage Stats service loaded.");
