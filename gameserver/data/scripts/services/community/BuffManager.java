...
import org.mmocore.commons.collections.GCSArray;
import org.mmocore.commons.dbutils.DbUtils;
import org.mmocore.gameserver.Config;
import org.mmocore.gameserver.ThreadPoolManager;
import org.mmocore.gameserver.dao.BuffManagerDAO;
...
public class BuffManager implements ScriptFile, ICommunityBoardHandler
{
	...
	public void onLoad()
	{
		if(Config.BBS_PVP_CB_ENABLED && Config.BBS_PVP_BUFFER_ENABLED)
		{
	...
	private void BuffOne(Player activeChar, int buffIdUse, int buffLvL)
	{
		...
		else
		{
			...
			AutoBan.Banned(activeChar, 999999, "Cheater detected! AUTO BAN!", "REBELLION"); // Ban this player
	...
	private void AddBuffInGrp(Player activeChar, int gpIdUse, int buff, int lvl)
	{
		...
		try
		{
			...
			if(rs.getInt(1) <= 26)
			{
				...
				activeChar.sendMessage("Набор не может содержать более " + Config.BBS_PVP_BUFFER_BUFFS_PER_PAGE + " баффов");
			DbUtils.closeQuietly(st, rs);
		}
		catch(Exception e)
		{}
	...
	private void EditeAddBuffInGrp(Player activeChar, int gpIdUse, int page)
	{
		...
		try
		{
			...
			htmltoppanel.append("<td><button value=\"Назад\" action=\"bypass -h _bbsbuff;use;" + GrpID + "\" width=50 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td>");
			htmltoppanel.append("</tr>");
			htmltoppanel.append("</table>");

			String content = HtmCache.getInstance().getNotNull(Config.BBS_HOME_DIR + "pages/buff_1.htm", activeChar); // 601
	...
	private void EditeBuffGrp(Player activeChar, int gpIdUse)
	{
		...
		try
		{
			...
			htmltoppanel.append("<td><font color=30D249>Редактирование: " + GrpName + "</font></td>");
			htmltoppanel.append("<td></td>");
			htmltoppanel.append("<td><button value=\"Добавить бафф\" action=\"bypass -h _bbsbuff;addbuffin;" + GrpID + ";1\" width=140 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td>");
			htmltoppanel.append("<td><button value=\"Удалить набор\" action=\"bypass -h _bbsbuff;dellGrp;" + GrpID + "\" width=140 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td>");
			htmltoppanel.append("<td><button value=\"Назад\" action=\"bypass -h _bbsbuff;use;" + GrpID + "\" width=100 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td>");
			htmltoppanel.append("</tr>");
			htmltoppanel.append("</table>");
	...
	private void UseFixedBuffGrp(Player activeChar, String GrpName, int page)
	{
		...
		int price = 0;
		double numpages = 0;
		Summon l2Summon = activeChar.getFirstPet();
		int offset = Config.BBS_PVP_BUFFER_BUFFS_PER_PAGE * (page - 1);
		Connection con = null;
		...
		try
		{
			...
			if(numpages <= 1)
			{
				...
				htmltoppanel.append("<td><button value=\"Все\" action=\"bypass -h _bbsbuff;bufffixedgrp;" + GrpName + "; Player\" width=40 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td>");
				if(activeChar.getVar("autoBuff@") == null && activeChar.getVar("autoFixedBuff@") == null)
					htmltoppanel.append("<td><button value=\"Включить авто-бафф\" action=\"bypass -h _bbsbuff;buffgrpauto;0;" + GrpName + ";" + price + "\" width=140 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td>");
				else
					htmltoppanel.append("<td><button value=\"Отключить авто-бафф\" action=\"bypass -h _bbsbuff;buffgrpautostop;0;" + GrpName + "\" width=140 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td>");
			}
			else
			...
			if(l2Summon != null)
			{
				...
				if(numpages <= 1)
				{
					...
					htmltoppanel.append("<td><button value=\"Все\" action=\"bypass -h _bbsbuff;bufffixedgrp;" + GrpName + "; Pet\" width=40 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td>");
					if(activeChar.getVar("autoBuffPet@") == null && activeChar.getVar("autoFixedBuffPet@") == null)
						htmltoppanel.append("<td><button value=\"Включить авто-бафф\" action=\"bypass -h _bbsbuff;buffgrpautopet;0;" + GrpName + ";" + price + "\" width=140 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td>");
					else
						htmltoppanel.append("<td><button value=\"Отключить авто-бафф\" action=\"bypass -h _bbsbuff;buffgrpautopetstop;0;" + GrpName + "\" width=140 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td>");
				}
				htmltoppanel.append("<td></td>");
				htmltoppanel.append("</tr>");
			}
	...
	private void UseBuffGrp(Player activeChar, int gpIdUse)
	{
		...
		try
		{
			...
			htmltoppanel.append("</td>");
			htmltoppanel.append("<td>Себе:</td>");
			htmltoppanel.append("<td><button value=\"Все\" action=\"bypass -h _bbsbuff;buffgrp;" + GrpID + "; Player\" width=40 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td>");

			if(activeChar.getVar("autoBuff@") == null && activeChar.getVar("autoFixedBuff@") == null)
				htmltoppanel.append("<td><button value=\"Включить авто-бафф\" action=\"bypass -h _bbsbuff;buffgrpauto;" + GrpID + ";null;" + price + "\" width=140 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td>");
			else
				htmltoppanel.append("<td><button value=\"Отключить авто-бафф\" action=\"bypass -h _bbsbuff;buffgrpautostop;" + GrpID + ";null\" width=140 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td>");
			htmltoppanel.append("<td><button value=\"Редактировать\" action=\"bypass -h _bbsbuff;editegrp;" + GrpID + "\" width=100 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td>");
			htmltoppanel.append("</tr>");
			...
			if(l2Summon != null)
			{
				...
				htmltoppanel.append("<td></td>");
				htmltoppanel.append("<td>Питомец:</td>");
				htmltoppanel.append("<td><button value=\"Все\" action=\"bypass -h _bbsbuff;buffgrp;" + GrpID + "; Pet\" width=40 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td>");
				if(activeChar.getVar("autoBuffPet@") == null && activeChar.getVar("autoFixedBuffPet@") == null)
					htmltoppanel.append("<td><button value=\"Включить авто-бафф\" action=\"bypass -h _bbsbuff;buffgrpautopet;" + GrpID + ";null;" + price + "\" width=140 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td>");
				else
					htmltoppanel.append("<td><button value=\"Отключить авто-бафф\" action=\"bypass -h _bbsbuff;buffgrpautopetstop;" + GrpID + ";null\" width=140 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td>");
				htmltoppanel.append("<td></td>");
				htmltoppanel.append("</tr>");
			}
	...
	private void showBuffIndexPage(Player activeChar)
	{
		...
		try
		{
			...
			while(rs.next())
			{
				...
				html.append("<tr>");
				html.append("<td>");
				html.append("<button value=\"" + bgrp.GpName + "\" action=\"bypass -h _bbsbuff;use;" + bgrp.GpId + "\" width=190 height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">");
				html.append("</td>");
				html.append("</tr>");
			}
			html.append("</table>");
			...
			String content = HtmCache.getInstance().getNotNull(Config.BBS_HOME_DIR + "pages/buff.htm", activeChar); // 60
		...
		for(int i = 0; i < (int) rows; i++)
		{
			...
			for(int j = 0; j < cols_number; j++)
			{
				if(buffIds.size() > c)
				{
					...
					if(type == 1)
						bottom = "<td width=25><button value=\"$\" action=\"bypass -h _bbsbuff;buff;" + buffIds.get(c) + ";" + skill.getBaseLevel() + "\" width=25 height=32 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>";
					else if(type == 2)
						bottom = "<td width=25><button value=\">\" action=\"bypass -h _bbsbuff;dellbufffrom;" + grpId + ";" + buffIds.get(c) + "\" width=25 height=32 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>";
					else if(type == 3)
						bottom = "<td width=25><button value=\"<\" action=\"bypass -h _bbsbuff;addbuffingrp;" + grpId + ";" + buffIds.get(c) + ";" + skill.getBaseLevel() + "\" width=25 height=32 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>";
	...
	public static String page_list(double numpages, int page, int GrpID, String GrpName)
	{
		...
		String pager = "";
		pager += page > 1 ? "<td width=50><center><button value=\"<<<\" action=\"bypass -h _bbsbuff;" + cmd + ";" + index + ";" + (page - 1) + "\" width=50 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></center></td>" : "<td width=50></td>";
		pager += "<td width=50><center>Page №" + page + "</center></td>";
		pager += page < numpages ? "<td width=50><center><button value=\">>>\" action=\"bypass -h _bbsbuff;" + cmd + ";" + index + ";" + (page + 1) + "\" width=50 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></center></td>" : "<td width=50></td>";
	...
	public boolean chekCondition(Player activeChar)
	{
		...
		if(!Config.BBS_PVP_BUFFER_ALOWED_INST_BUFF)
			...
			{
				activeChar.sendMessage("Невозможно использовать в данных зонах!");
				return false;
			}
		...
		if(!Config.BBS_PVP_BUFFER_ALLOW_SIEGE)
			...
			{
				activeChar.sendMessage("Невозможно использовать во время осад!");
				return false;
			}
		return true;
	}
	...
	public class buffTaskPet
	{
		...
		class buffPet implements Runnable
		{
			...
			public void run()
			{
				try
				{
					Summon l2Summon = activeChartoBuff.getFirstPet();
