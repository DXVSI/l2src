...
public class Mammons extends Functions implements ScriptFile
{
	...
	private static final Location[] MAMMON_PRIEST_POINTS = {
		...
		new Location(81284, 150155, -3536, 64087), // Giran
		new Location(114478, 217596, -3632, 61496), // Heine
		new Location(-12136, 121784, -2992, 27433), // Gludio
		new Location(-84808, 151416, -3120, 59718), // Gludin
		new Location(79976, 56968, -1568, 61318), // Oren
		new Location(144664, -54200, -2976, 40707), // Goddard
		new Location(90376, -143544, -1536, 41834), // Shuttgard
		new Location(42792, -41384, -2192, 30607), // Rune
		new Location(146968, 29656, -2272, 28713), // Aden
		new Location(120456, 76456, -2144, 30749), // Hunters
	};
		 
	private static final Location[] MAMMON_MERCHANT_POINTS = {
		new Location(16344, 144792, -3024, 27931), // Dion 
		new Location(81266, 150091, -3536, 64087), // Giran
		new Location(114482, 217538, -3632, 61496), // Heine
		new Location(-12120, 121848, -2992, 27433), // Gludio
		new Location(-84808, 151352, -3120, 61318), // Gludin
		new Location(79992, 56888, -1552, 59718), // Oren
		new Location(144584, -54184, -2976, 40707), // Goddard
		new Location(90232, -143592, -1536, 41834), // Shuttgard
		new Location(42776, -41320, -2192, 30607), // Rune
		new Location(146968, 29704, -2272, 28713), // Aden
		new Location(120440, 76504, -2144, 30749), // Hunters
	};
		 
	private static final Location[] MAMMON_BLACKSMITH_POINTS = {
		new Location(16360, 144856, -3024, 27931), // Dion
		new Location(81272, 150041, -3536, 64087), // Giran
		new Location(114484, 217462, -3632, 61496), // Heine
		new Location(-12120, 121912, -2992, 27433), // Gludio
		new Location(-84808, 151320, -3120, 59718), // Gludin
		new Location(79992, 56792, -1552, 61318), // Oren
		new Location(144520, -54152, -2976, 40707), // Goddard
		new Location(89992, -143672, -1536, 41834), // Shuttgard
		new Location(42760, -41256, -2192, 30607), // Rune
		new Location(146968, 29784, -2272), // Aden
		new Location(120408, 76568, -2144, 30749), // Hunters
	};
