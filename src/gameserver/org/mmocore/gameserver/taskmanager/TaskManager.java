...
import org.mmocore.gameserver.taskmanager.tasks.TaskRecom;
import org.mmocore.gameserver.taskmanager.tasks.WorldStatisticUpdate;
...
import static org.mmocore.gameserver.taskmanager.TaskTypes.*;
...
public final class TaskManager
{
	...
	static final String[] SQL_STATEMENTS = { "SELECT id,task,type,last_activation,param1,param2,param3 FROM global_tasks", "UPDATE global_tasks SET last_activation=? WHERE id=?",
	        "SELECT id FROM global_tasks WHERE task=?", "INSERT INTO global_tasks (task,type,last_activation,param1,param2,param3) VALUES(?,?,?,?,?,?)" };
