...
public class Wedding implements IVoicedCommandHandler
{
	private static class CoupleAnswerListener implements OnAnswerListener
	{
		...
		public void sayYes()
		{
			...
			player1.sendMessage(new CustomMessage("org.mmocore.gameserver.model.L2Player.EngageAnswerYes", player2));
		}
		...
		public void sayNo()
		{
			...
			player1.sendMessage(new CustomMessage("org.mmocore.gameserver.model.L2Player.EngageAnswerNo", player2));
		}
	}
	...
	public boolean goToLove(Player activeChar)
	{
		...
		if (partner.isInOlympiadMode() || activeChar.isMovementDisabled() || activeChar.isMuted(null) || activeChar.isInOlympiadMode() || activeChar.isInDuel()
		        || activeChar.getPlayer().isTerritoryFlagEquipped() || partner.isInZone(no_summon))
		{
