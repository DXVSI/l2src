...
public class AdminInstance implements IAdminCommandHandler
{
	...
	private void listOfInstances(Player activeChar)
	{
		...
		for (Reflection reflection : ReflectionManager.getInstance().getAll())
		{
			...
			replyMSG.append("<a action=\"bypass -h admin_instance_id ").append(reflection.getId()).append(" \">").append(reflection.getName()).append("(").append(countPlayers)
			        .append(" players). Id: ").append(reflection.getId()).append("</a><br>");
		}
