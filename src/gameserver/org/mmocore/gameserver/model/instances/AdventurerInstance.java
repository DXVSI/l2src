...
import org.mmocore.gameserver.network.serverpackets.ExShowQuestInfo;
			...
			try
			{
				...
				switch (RaidBossSpawnManager.getInstance().getRaidBossStatusId(bossId))
				{
					...
					case DEAD:
						...
						break;
					case UNDEFINED:
						player.sendMessage(new CustomMessage("org.mmocore.gameserver.model.instances.L2AdventurerInstance.BossNotInGame", player).addNumber(bossId));
						break;
				}
			}
