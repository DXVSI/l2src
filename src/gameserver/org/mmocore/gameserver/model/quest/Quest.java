...
import org.mmocore.gameserver.model.quest.startcondition.impl.ClassLevelCondition;
import org.mmocore.gameserver.model.quest.startcondition.impl.PlayerLevelCondition;
import org.mmocore.gameserver.model.quest.startcondition.impl.QuestCompletedCondition;
import org.mmocore.gameserver.network.serverpackets.ExNpcQuestHtmlMessage;
import org.mmocore.gameserver.network.serverpackets.ExQuestNpcLogList;
...
public class Quest
{
	...
	/**
	 * Добавляет нпц масив для слушателя при их убийстве, и обновлении пакетом {@link org.mmocore.gameserver.network.serverpackets.ExQuestNpcLogList}
	 * 
	 * @param cond
	 * @param varName
	 * @param killIds
