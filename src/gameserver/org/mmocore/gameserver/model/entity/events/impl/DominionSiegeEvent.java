...
import org.mmocore.gameserver.network.serverpackets.ExDominionWarEnd;
...
public class DominionSiegeEvent extends SiegeEvent<Dominion, SiegeClanObject>
{
	...
	public class KillListener implements OnKillListener
	{
		...
		public void onKill(Creature actor, Creature victim)
		{
			...
			if (winner == null || !victim.isPlayer() || winner.getLevel() < 40 || winner == victim || victim.getEvent(DominionSiegeEvent.class) == DominionSiegeEvent.this
			        || !actor.isInZone(Zone.ZoneType.SIEGE) || !victim.isInZone(Zone.ZoneType.SIEGE))
				return;
