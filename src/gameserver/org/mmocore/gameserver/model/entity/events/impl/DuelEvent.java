...
import org.mmocore.gameserver.network.serverpackets.ExDuelStart;
...
public abstract class DuelEvent extends GlobalEvent implements Iterable<DuelSnapshotObject>
{
	...
	protected IStaticPacket canDuel0(Player requestor, Player target)
	{
		...
		if (target.isInCombat())
			...
			packet = new SystemMessage2(
			        SystemMsg.C1_CANNOT_MAKE_A_CHALLENGE_TO_A_DUEL_BECAUSE_C1_IS_CURRENTLY_IN_A_DUELPROHIBITED_AREA_PEACEFUL_ZONE__SEVEN_SIGNS_ZONE__NEAR_WATER__RESTART_PROHIBITED_AREA)
			        .addName(target);
