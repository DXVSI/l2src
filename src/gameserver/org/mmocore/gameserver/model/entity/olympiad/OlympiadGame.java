...
import org.mmocore.gameserver.network.serverpackets.ExOlympiadUserInfo;
...
public class OlympiadGame
{
	...
	public void winGame(OlympiadTeam winnerTeam, OlympiadTeam looseTeam)
	{
		...
		if (member1 != null && member2 != null)
		{
			...
			OlympiadHistory h = new OlympiadHistory(member1.getObjectId(), member1.getObjectId(), member1.getClassId(), member2.getClassId(), member1.getName(), member2.getName(), _startTime, diff,
			        team, _type.ordinal());
		...
		Log.add("Olympiad Result: " + winnerTeam.getName() + " vs " + looseTeam.getName() + " ... (" + (int) winnerTeam.getDamage() + " vs " + (int) looseTeam.getDamage() + ") "
		        + winnerTeam.getName() + " win " + pointDiff + " points", "olympiad");
	}
