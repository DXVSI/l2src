...
import org.mmocore.gameserver.network.serverpackets.FlyToLocation.FlyType;
...
import org.mmocore.gameserver.skills.skillclasses.AIeffects;
import org.mmocore.gameserver.skills.skillclasses.Aggression;
import org.mmocore.gameserver.skills.skillclasses.Balance;
import org.mmocore.gameserver.skills.skillclasses.BeastFeed;
import org.mmocore.gameserver.skills.skillclasses.BuffCharger;
import org.mmocore.gameserver.skills.skillclasses.CPDam;
import org.mmocore.gameserver.skills.skillclasses.Call;
import org.mmocore.gameserver.skills.skillclasses.ChainHeal;
import org.mmocore.gameserver.skills.skillclasses.Charge;
import org.mmocore.gameserver.skills.skillclasses.ChargeSoul;
import org.mmocore.gameserver.skills.skillclasses.ClanGate;
import org.mmocore.gameserver.skills.skillclasses.CombatPointHeal;
import org.mmocore.gameserver.skills.skillclasses.Continuous;
import org.mmocore.gameserver.skills.skillclasses.Craft;
import org.mmocore.gameserver.skills.skillclasses.DeathPenalty;
import org.mmocore.gameserver.skills.skillclasses.Decoy;
import org.mmocore.gameserver.skills.skillclasses.Default;
import org.mmocore.gameserver.skills.skillclasses.DefuseTrap;
import org.mmocore.gameserver.skills.skillclasses.DeleteHate;
import org.mmocore.gameserver.skills.skillclasses.DeleteHateOfMe;
import org.mmocore.gameserver.skills.skillclasses.DestroySummon;
import org.mmocore.gameserver.skills.skillclasses.DetectTrap;
import org.mmocore.gameserver.skills.skillclasses.Disablers;
import org.mmocore.gameserver.skills.skillclasses.Drain;
import org.mmocore.gameserver.skills.skillclasses.DrainSoul;
import org.mmocore.gameserver.skills.skillclasses.EMDam;
import org.mmocore.gameserver.skills.skillclasses.EffectsFromSkills;
import org.mmocore.gameserver.skills.skillclasses.EnergyReplenish;
import org.mmocore.gameserver.skills.skillclasses.ExtractStone;
import org.mmocore.gameserver.skills.skillclasses.FishingSkill;
import org.mmocore.gameserver.skills.skillclasses.Harvesting;
import org.mmocore.gameserver.skills.skillclasses.Heal;
import org.mmocore.gameserver.skills.skillclasses.HealHpCp;
import org.mmocore.gameserver.skills.skillclasses.HealPercent;
import org.mmocore.gameserver.skills.skillclasses.HealWithCp;
import org.mmocore.gameserver.skills.skillclasses.KamaelWeaponExchange;
import org.mmocore.gameserver.skills.skillclasses.KnowItem;
import org.mmocore.gameserver.skills.skillclasses.LethalShot;
import org.mmocore.gameserver.skills.skillclasses.MDam;
import org.mmocore.gameserver.skills.skillclasses.ManaDam;
import org.mmocore.gameserver.skills.skillclasses.ManaHeal;
import org.mmocore.gameserver.skills.skillclasses.ManaHealPercent;
import org.mmocore.gameserver.skills.skillclasses.NegateEffects;
import org.mmocore.gameserver.skills.skillclasses.NegateStats;
import org.mmocore.gameserver.skills.skillclasses.PDam;
import org.mmocore.gameserver.skills.skillclasses.PcBangPointsAdd;
import org.mmocore.gameserver.skills.skillclasses.PetSummon;
import org.mmocore.gameserver.skills.skillclasses.Recall;
import org.mmocore.gameserver.skills.skillclasses.ReelingPumping;
import org.mmocore.gameserver.skills.skillclasses.Refill;
import org.mmocore.gameserver.skills.skillclasses.Replace;
import org.mmocore.gameserver.skills.skillclasses.Resurrect;
import org.mmocore.gameserver.skills.skillclasses.Ride;
import org.mmocore.gameserver.skills.skillclasses.SPHeal;
import org.mmocore.gameserver.skills.skillclasses.EXPHeal;
import org.mmocore.gameserver.skills.skillclasses.ShiftAggression;
import org.mmocore.gameserver.skills.skillclasses.Sowing;
import org.mmocore.gameserver.skills.skillclasses.Spoil;
import org.mmocore.gameserver.skills.skillclasses.StealBuff;
import org.mmocore.gameserver.skills.skillclasses.Subjob;
import org.mmocore.gameserver.skills.skillclasses.SummonItem;
import org.mmocore.gameserver.skills.skillclasses.SummonMentor;
import org.mmocore.gameserver.skills.skillclasses.SummonSiegeFlag;
import org.mmocore.gameserver.skills.skillclasses.Sweep;
import org.mmocore.gameserver.skills.skillclasses.TakeCastle;
import org.mmocore.gameserver.skills.skillclasses.TakeFlag;
import org.mmocore.gameserver.skills.skillclasses.TakeFortress;
import org.mmocore.gameserver.skills.skillclasses.TameControl;
import org.mmocore.gameserver.skills.skillclasses.TeleportNpc;
import org.mmocore.gameserver.skills.skillclasses.Toggle;
import org.mmocore.gameserver.skills.skillclasses.Transformation;
import org.mmocore.gameserver.skills.skillclasses.Unlock;
import org.mmocore.gameserver.skills.skillclasses.Teleport;
import org.mmocore.gameserver.skills.skillclasses.VitalityHeal;
...
public abstract class Skill extends StatTemplate implements Cloneable {
    ...
    public boolean checkCondition(Creature activeChar, Creature target, boolean forceUse, boolean dontMove, boolean first) {
        ...
        if (first
                    && activeChar.getCurrentMp() < (isMagic() ? _mpConsume1 + activeChar.calcStat(Stats.MP_MAGIC_SKILL_CONSUME, _mpConsume2, target, this) : _mpConsume1
                                                                                                                                                                     + activeChar.calcStat(Stats.MP_PHYSICAL_SKILL_CONSUME, _mpConsume2, target, this))) {
    ...
    public SystemMsg checkTarget(Creature activeChar, Creature target, Creature aimingTarget, boolean forceUse, boolean first) {
        ...
        if (!first && target != activeChar && target == aimingTarget && getCastRange() > 0 && getCastRange() != 32767
    ...
    public final Creature getAimingTarget(Creature activeChar, GameObject obj) {
        ...
        switch (_targetType) {
            ...
            case TARGET_PARTY_ONE:
                ...
                if (ptarget != null && player != null && player.getParty() != null && player.getParty().containsMember(ptarget) && target.isDead() == _isCorpse
                            && !(target == activeChar && isOffensive()) && (!_isUndeadOnly || target.isUndead()))
                    return target;
                return null;
            case TARGET_AREA:
    ...
    private void addTargetsToList(GArray<Creature> targets, Creature aimingTarget, Creature activeChar, boolean forceUse) {
        ...
        if (_targetType == SkillTargetType.TARGET_TUNNEL) {
            ...
            terr = new Polygon().add(activeChar.getX() + (int) (Math.cos(radian1) * radius), activeChar.getY() + (int) (Math.sin(radian1) * radius))
                           ...
                           .add(aimingTarget.getX() + (int) (Math.cos(radian1) * radius), aimingTarget.getY() + (int) (Math.sin(radian1) * radius)).setZmin(Math.min(zmin1, zmin2))
     ...
     */
    public final void getEffects(final Creature effector, final Creature effected, final boolean calcChance, final boolean applyOnCaster, final long timeConst, final double timeMult,
