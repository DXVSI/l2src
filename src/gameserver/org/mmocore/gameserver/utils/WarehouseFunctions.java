...
import org.mmocore.gameserver.network.serverpackets.WareHouseDepositList;
import org.mmocore.gameserver.network.serverpackets.WareHouseWithdrawList;
...
public final class WarehouseFunctions
{
	...
	public static void showDepositWindowClan(Player player)
	{
		...
		if (!(player.isClanLeader() || (Config.ALT_ALLOW_OTHERS_WITHDRAW_FROM_CLAN_WAREHOUSE || player.getVarB("canWhWithdraw"))
