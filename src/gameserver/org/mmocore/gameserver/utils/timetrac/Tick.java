...
public class Tick {
    ...
    public void log() {
        ...
        LOGGER.info("tick duration [" + duration() + "]" + TimeTracker.MLS + ", [" + (stopFreeMemory - startFreeMemory)
                + "]" + TimeTracker.BYTES + " used, free memory remains [" + stopFreeMemory + "]" + TimeTracker.BYTES);
    }
}
