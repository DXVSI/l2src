...
public class EffectDamOverTime extends Effect
{
	...
	public boolean onActionTime()
	{
		...
		_effected.reduceCurrentHp(damage, 0, _effector, getSkill(), !_effected.isNpc() && _effected != _effector, _effected != _effector, _effector.isNpc() || _effected == _effector, false, false,
		        true, false);
