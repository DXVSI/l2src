...
public enum EffectType
{
	...
	AbsorbDamageToEffector(EffectBuff.class, null, false), // абсорбирует часть
	                                                       // дамага к еффектора
	                                                       // еффекта
	AbsorbDamageToMp(EffectBuff.class, null, false), // абсорбирует часть дамага
	                                                 // в мп
	AbsorbDamageToSummon(EffectLDManaDamOverTime.class, null, true); // абсорбирует
	                                                                 // часть
	                                                                 // дамага к
	                                                                 // сумону
