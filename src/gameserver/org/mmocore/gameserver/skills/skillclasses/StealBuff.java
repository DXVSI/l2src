...
public class StealBuff extends Skill
{
	...
	{
		return e != null && e.isInUse() && e.isCancelable() && !e.getSkill().isToggle() && !e.getSkill().isPassive() && !e.getSkill().isOffensive() && e.getEffectType() != EffectType.Vitality
		        && !e.getTemplate()._applyOnCaster;
	}
