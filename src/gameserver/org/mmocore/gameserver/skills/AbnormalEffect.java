...
{
	NULL("null", 0), BLEEDING("bleeding", 1), POISON("poison", 2), REDCIRCLE("redcircle", 3), ICE("ice", 4),

	AFFRAID("affraid", 5), CONFUSED("confused", 6), STUN("stun", 7), SLEEP("sleep", 8),

	MUTED("muted", 9), ROOT("root", 10), HOLD_1("hold1", 11), HOLD_2("hold2", 12), // эффект
	                                                                               // от
	                                                                               // Dance
	                                                                               // of
	                                                                               // Medusa
	...
	DANCE_STUNNED("dancestun", 19), // танцует
	                                // со
	                                // звездочками
	                                // над
	                                // головой
	FIREROOT_STUN("firerootstun", 20), // красная аура у ног со звездочками над
	                                   // головой

	STEALTH("shadow", 21),
	IMPRISIONING_1("imprison1", 22), // синяя аура на
	                                 // уровне пояса
	...
	S_YELLOW_AFFRO("yellowafro", 37, true), // Большая круглая желтая прическа с
	                                        // воткнутой в волосы расческой
	S_PINK_AFFRO("pinkafro", 38, true), // Большая круглая розовая прическа с
	                                    // воткнутой в волосы расческой
	S_BLACK_AFFRO("blackafro", 39, true), // Большая круглая черная прическа с
	                                      // воткнутой в волосы расческой
	...
	S_SOA_RESP("soa_respawn", 47, true), // Мобы на респе СОА появляются с таким
	                                     // абнормалом
