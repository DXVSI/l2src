...
import org.mmocore.gameserver.model.quest.dynamic.DynamicQuestParticipant;
import org.mmocore.gameserver.model.quest.dynamic.DynamicQuestTask;
...
public class ExDynamicQuestPacket extends L2GameServerPacket {
    ...
    */
	...
	public static class DynamicQuestInfo { // Base class, subType = 0 - start, subType = 1 - end quest
