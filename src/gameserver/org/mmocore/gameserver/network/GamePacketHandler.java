...
import org.mmocore.gameserver.network.clientpackets.*;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

public final class GamePacketHandler implements IPacketHandler<GameClient>, IClientFactory<GameClient>,
		...
		try {
			...
			case IN_GAME:
				...
				case 0x4a:
					...
					switch (id2) {
					case 0x00:
						// msg = new SendCharacterInfo(); // Format:
						// S
						break;
					case 0x01:
						...
						break;
					case 0x02:
						// msg = new SendServerStatus(); // Format:
						// (noargs)
						break;
					case 0x03:
				...
				case 0xd0:
					...
					case 0x1a:
						// msg = new ?();
						// format: (ch)b, b - array размером в 64
						// байта
						break;
					case 0x1b:
					...
					case 0x1d:
						...
						// Format: d / требует отладки, ИМХО, это
						// совсем другой пакет (с) Drin
						break;
					case 0x1e:
						msg = new RequestExRqItemLink(); // chat
															// item
															// links
						break;
					case 0x1f:
					...
					case 0x23:
						...
						break;
					case 0x24:
						msg = new RequestSaveInventoryOrder(); // сохранение
																// порядка
																// инвентаря
						break;
					case 0x25:
					...
					case 0x2d:
						...
						break;
					case 0x2e:
						msg = new RequestExOlympiadObserverEnd(); // не
																	// уверен
																	// (в
																	// клиенте
																	// называется
					...
					case 0x35:
						...
						break;
					case 0x36:
						// RequestGotoLobby - случается при
						// многократном нажатии кнопки "вход"
						break;
					case 0x38:
					...
					case 0x83:
						...
						switch (id5) {
						/*
						 * TODO: case 0x01: //msg = new RequestExAgitInitialize chd 0x01 break; case 0x02: //msg = new
						 * RequestExAgitDetailInfo chdcd 0x02 break; case 0x03: //msg = new RequestExMyAgitState chd
						 * 0x03 break; case 0x04: //msg = new RequestExRegisterAgitForBidStep1 chd 0x04 break; case
						 * 0x05: //msg = new RequestExRegisterAgitForBidStep2 chddQd 0x05 //msg = new
						 * RequestExRegisterAgitForBidStep3 chddQd 0x05 -no error? 0x05 break; case 0x07: //msg = new
						 * RequestExConfirmCancelRegisteringAgit chd 0x07 break; case 0x08: //msg = new
						 * RequestExProceedCancelRegisteringAgit chd 0x08 break; case 0x09: //msg = new
						 * RequestExConfirmCancelAgitBid chdd 0x09 break; case 0x10: //msg = new RequestExReBid chdd
						 * 0x10 break; case 0x11: //msg = new RequestExAgitListForLot chd 0x11 break; case 0x12: //msg =
						 * new RequestExApplyForAgitLotStep1 chdc 0x12 break; case 0x13: //msg = new
						 * RequestExApplyForAgitLotStep2 chdc 0x13 break; case 0x14: //msg = new RequestExAgitListForBid
						 * chdd 0x14 break; case 0x0D: //msg = new RequestExApplyForBidStep1 chdd 0x0D break; case 0x0E:
						 * //msg = new RequestExApplyForBidStep2 chddQ 0x0E break; case 0x0F: //msg = new
						 * RequestExApplyForBidStep3 chddQ 0x0F break; case 0x09: //msg = new
						 * RequestExConfirmCancelAgitLot chdc 0x09 break; case 0x0A: //msg = new
						 * RequestExProceedCancelAgitLot chdc 0x0A break; case 0x0A: //msg = new
						 * RequestExProceedCancelAgitBid chdd 0x0A break;
						 */
						}
						break;
					case 0x84:
					...
					case 0x94:
						...
						break;
					case 0x96: // TODO[K] - All dynamic quest
						// system(sniff need :( )
						int id6 = buf.get();
						switch (id6) {
						case 0x02:
					...
					case 0xBF:
						...
						break;
					/*
					 * //TODO[Andrey A.]:Треуется опкод для данного пакета
					 * 
					 * case 0xc0: msg = new RequestMenteeSearch(); break;
					 */
					default:
						client.onUnknownPacket();
						break;
