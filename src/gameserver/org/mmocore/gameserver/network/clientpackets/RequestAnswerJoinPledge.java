...
public class RequestAnswerJoinPledge extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		try
		{
			...
			UnitMember member = new UnitMember(clan, player.getName(), player.getTitle(), player.getLevel(), player.getClassId().getId(), player.getObjectId(), pledgeType, player.getPowerGrade(),
