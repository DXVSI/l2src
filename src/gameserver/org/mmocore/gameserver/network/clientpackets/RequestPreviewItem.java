...
import org.mmocore.gameserver.network.serverpackets.ShopPreviewInfo;
import org.mmocore.gameserver.network.serverpackets.ShopPreviewList;
	...
	protected void runImpl()
	{
		...
		try
		{
			for (int i = 0; i < _count; i++)
			{
				...
				{
					if (template.getItemType() == ArmorType.HEAVY || template.getItemType() == ArmorType.MAGIC || template.getItemType() == ArmorType.SIGIL
