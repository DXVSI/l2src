...
public class RequestPledgeReorganizeMember extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		{
			activeChar.sendMessage(new CustomMessage("org.mmocore.gameserver.clientpackets.RequestPledgeReorganizeMember.ChangeAffiliations", activeChar));
			activeChar.sendActionFailed();
			return;
		}
		...
		if (subject == null)
		{
			activeChar.sendMessage(new CustomMessage("org.mmocore.gameserver.clientpackets.RequestPledgeReorganizeMember.NotInYourClan", activeChar));
			activeChar.sendActionFailed();
			return;
		}
		...
		{
			activeChar.sendMessage(new CustomMessage("org.mmocore.gameserver.clientpackets.RequestPledgeReorganizeMember.AlreadyInThatCombatUnit", activeChar));
			activeChar.sendActionFailed();
			return;
		}
		...
		{
			activeChar.sendMessage(new CustomMessage("org.mmocore.gameserver.clientpackets.RequestPledgeReorganizeMember.NoSuchCombatUnit", activeChar));
			activeChar.sendActionFailed();
			return;
		}
		...
		{
			activeChar.sendMessage(new CustomMessage("org.mmocore.gameserver.clientpackets.RequestPledgeReorganizeMember.AcademyViaInvitation", activeChar));
			activeChar.sendActionFailed();
			return;
		}
		/*
		...
		{
			activeChar.sendMessage(new CustomMessage("org.mmocore.gameserver.clientpackets.RequestPledgeReorganizeMember.CantMoveAcademyMember", activeChar));
			activeChar.sendActionFailed();
			return;
		}
		...
		if (_replace > 0)
		{
			...
			if (replacement == null)
			{
				activeChar.sendMessage(new CustomMessage("org.mmocore.gameserver.clientpackets.RequestPledgeReorganizeMember.CharacterNotBelongClan", activeChar));
				activeChar.sendActionFailed();
				return;
			}
			if (replacement.getPledgeType() != _targetUnit)
			{
				activeChar.sendMessage(new CustomMessage("org.mmocore.gameserver.clientpackets.RequestPledgeReorganizeMember.CharacterNotBelongCombatUnit", activeChar));
				activeChar.sendActionFailed();
				return;
			}
			if (replacement.isSubLeader() != 0)
			{
				activeChar.sendMessage(new CustomMessage("org.mmocore.gameserver.clientpackets.RequestPledgeReorganizeMember.CharacterLeaderAnotherCombatUnit", activeChar));
				activeChar.sendActionFailed();
				return;
			}
		}
		else
		{
			...
			{
				activeChar.sendMessage(new CustomMessage("org.mmocore.gameserver.clientpackets.RequestPledgeReorganizeMember.MemberLeaderAnotherUnit", activeChar));
				activeChar.sendActionFailed();
				return;
			}
