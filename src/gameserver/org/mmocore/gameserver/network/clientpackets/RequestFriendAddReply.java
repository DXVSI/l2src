...
import org.mmocore.gameserver.network.serverpackets.L2Friend;
...
public class RequestFriendAddReply extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		requestor.sendPacket(Msg.YOU_HAVE_SUCCEEDED_IN_INVITING_A_FRIEND, new SystemMessage(SystemMessage.S1_HAS_BEEN_ADDED_TO_YOUR_FRIEND_LIST).addString(activeChar.getName()), new L2Friend(
		        activeChar, true));
