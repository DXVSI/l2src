...
import static org.mmocore.gameserver.geodata.GeoEngine.*;
...
public class PathFind
{
	...
	public PathFind(int x, int y, int z, int destX, int destY, int destZ, GameObject obj, int geoIndex)
	{
		...
		endPoint = Config.PATHFIND_BOOST != 2 || Math.abs(destZ - z) > 200 ? new Location(destX, destY, destZ) : GeoEngine.moveCheckBackwardWithCollision(destX, destY, destZ, startPoint.x,
		        startPoint.y, true, geoIndex);
