...
import org.mmocore.gameserver.loginservercon.ServerType;
...
public class Config
{
	...
	public static final String BBS_CONFIG_FILE = "config/BBS.properties";
	...
	public static boolean BBS_PVP_STATS_ENABLED;
	...
	public static boolean BBS_CLASS_ENABLED;
	public static boolean BBS_BUFF_ENABLED;
	public static boolean BBS_MULTISELL_ENABLED;
	public static boolean BBS_TELEPORT_ENABLED;

	public static int BBS_BUFF_PRICEID;
	public static int BBS_BUFF_PRICECOUNT;
	public static int BBS_BUFF_TIME;
	public static boolean BBS_BUFF_SAVE;
	public static int BBS_BUFF_RESTORE_ID;
	public static int BBS_BUFF_RESTORE_COUNT;

	public static int BBS_BUFF_GRP_PRICE_ID;
	public static int BBS_BUFF_GRP_PRICE_COUNT;
	...
	public static void loadProtectionConfig()
	{
		...
		SECOND_AUTH_REC_LINK = protectSettings.getProperty("SecondAuthRecoveryLink", "http://la2era.ru/");
	}

	public static void loadBBSConfig()
	{
		ExProperties bbsSetting = load(BBS_CONFIG_FILE);

		COMMUNITYBOARD_ENABLED = bbsSetting.getProperty("AllowCommunityBoard", true);
		BBS_DEFAULT = bbsSetting.getProperty("BBSDefault", "_bbshome");
		BBS_HOME_DIR = bbsSetting.getProperty("BBSHomeDir", "scripts/services/community/");

		BBS_PVP_CB_ABNORMAL = bbsSetting.getProperty("BBSPVPAllowAbnormal", false);
		BBS_PVP_CB_ENABLED = bbsSetting.getProperty("BBSPVPEnabled", false);

		BBS_PVP_SUB_MANAGER_ALLOW = bbsSetting.getProperty("BBSPVPSubManagerAllow", false);
		BBS_PVP_SUB_MANAGER_PIACE = bbsSetting.getProperty("BBSPVPSubManagerPiace", false);

		BBS_PVP_ALLOW_SELL = bbsSetting.getProperty("BBSPVPAllowSell", false);

		BBS_PVP_TELEPORT_ENABLED = bbsSetting.getProperty("BBSPVPTeleportEnabled", false);
		BBS_PVP_TELEPORT_POINT_PRICE = bbsSetting.getProperty("BBSPVPTeleportPointPrice", 200000);
		BBS_PVP_TELEPORT_MAX_POINT_COUNT = bbsSetting.getProperty("BBSPVPTeleportMaxPointCount", 10);

		BBS_PVP_BUFFER_ENABLED = bbsSetting.getProperty("BBSPVPBufferEnabled", false);
		BBS_PVP_BUFFER_ALT_TIME = bbsSetting.getProperty("BBSPVPBufferTime", 14400) * 1000;
		BBS_PVP_BUFFER_PRICE_ITEM = bbsSetting.getProperty("BBSPVPBufferPriceItem", 57);
		BBS_PVP_BUFFER_PRICE_ONE = bbsSetting.getProperty("BBSPVPBufferPriceOne", 1000);
		BBS_PVP_BUFFER_BUFFS_PER_PAGE = bbsSetting.getProperty("BBSPVPBufferMaxPerPage", 27);
		BBS_PVP_BUFFER_TASK_DELAY = bbsSetting.getProperty("BBSPVPBufferTaskDelay", 14400) * 1000;
		BBS_PVP_BUFFER_MIN_LVL = bbsSetting.getProperty("BBSPVPBufferMinLvl", 1);
		BBS_PVP_BUFFER_MAX_LVL = bbsSetting.getProperty("BBSPVPBufferMaxLvl", 99);
		BBS_PVP_BUFER_ONE_BUFF_PET = bbsSetting.getProperty("BBSPVPBufferOneBuffPet", false);
		BBS_PVP_BUFFER_ALLOW_SIEGE = bbsSetting.getProperty("BBSPVPBufferAllowOnSiege", true);
		BBS_PVP_BUFFER_ALOWED_INST_BUFF = bbsSetting.getProperty("BBSPVPBufferAllowInInstance", true);
		BBS_PVP_STATS_ENABLED = bbsSetting.getProperty("BBSPVPStatsEnabled", false);
	}
	...
	public static void loadPvPSettings()
	{
		...
		for (int id : pvpSettings.getProperty("ListOfNonDroppableItems", new int[] { 57, 1147, 425, 1146, 461, 10, 2368, 7, 6, 2370, 2369, 3500, 3501, 3502, 4422, 4423, 4424, 2375, 6648, 6649, 6650,
		        6842, 6834, 6835, 6836, 6837, 6838, 6839, 6840, 5575, 7694, 6841, 8181 }))
