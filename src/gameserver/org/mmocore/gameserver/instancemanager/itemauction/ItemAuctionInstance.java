		...
		public void runImpl() throws Exception
		{
			...
			switch (state)
			{
				case CREATED:
				{
					...
					{
						String[] params = {};
						Announcements.getInstance().announceByCustomMessage("org.mmocore.gameserver.model.instances.L2ItemAuctionBrokerInstance.announce." + _auction.getInstanceId(), params);
					}
					checkAndSetCurrentAndNextAuction();
					break;
				}
