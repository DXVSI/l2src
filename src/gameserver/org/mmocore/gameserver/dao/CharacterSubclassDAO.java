...
import org.mmocore.gameserver.model.DeathPenalty;
...
public class CharacterSubclassDAO
{
	...
	public boolean insert(int objId, int classId, long exp, int sp, double curHp, double curMp, double curCp, double maxHp, double maxMp, double maxCp, int level, boolean active, SubClassType type,
	        DeathPenalty deathPenalty, int certification)
	{
		Connection con = null;
