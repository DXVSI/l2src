...
public final class PlayerTemplate extends CharTemplate
{
	...
	public PlayerTemplate(StatsSet set, Sex sex, StatAttributes minAttr, StatAttributes maxAttr, StatAttributes baseAttr, BaseArmorDefence armDef, BaseJewelDefence jewlDef, List<Location> startLocs,
	        List<StartItem> startItems, TIntObjectHashMap<LvlUpData> lvlUpData)
	{
		super(set);
		_sex = sex;
		_minAttr = minAttr;
