...
public abstract class ItemTemplate extends StatTemplate
{
	public static enum ReuseType
	{
		...
		EVERY_DAY_AT_6_30(SystemMsg.THERE_ARE_S2_SECONDS_REMAINING_FOR_S1S_REUSE_TIME, SystemMsg.THERE_ARE_S2_MINUTES_S3_SECONDS_REMAINING_FOR_S1S_REUSE_TIME,
	...
	{
		NONE(CRYSTAL_NONE, 0), D(CRYSTAL_D, 1), C(CRYSTAL_C, 2), B(CRYSTAL_B, 3), A(CRYSTAL_A, 4), S(CRYSTAL_S, 5), S80(CRYSTAL_S, 5), S84(CRYSTAL_S, 5), R(CRYSTAL_R, 6), R95(CRYSTAL_R, 6), R99(
		        CRYSTAL_R, 6);
	...
	{
		return _itemId >= 13740 && _itemId <= 13748 || _itemId >= 14592 && _itemId <= 14600 || _itemId >= 14664 && _itemId <= 14672 || _itemId >= 14801 && _itemId <= 14809 || _itemId >= 15282
		        && _itemId <= 15299;
	}
	...
	{
		return getItemType() == EtcItemType.BAIT || getItemType() == EtcItemType.ARROW || getItemType() == EtcItemType.UNLIMITED_ARROW || getItemType() == EtcItemType.BOLT
		        || !(getBodyPart() == 0 || this instanceof EtcItemTemplate);
	}
