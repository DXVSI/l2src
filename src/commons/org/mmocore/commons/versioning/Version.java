...
public class Version
{
	...
	public Version(Class<?> c)
	{
		...
		try
		{
			...
			if (jarName != null && jarName.exists() && jarName.isFile() && jarName.getName().toLowerCase().endsWith(".jar"))
			{
			...
			{
				_log.info("Running in development mode - no JAR file found, using default version information");
			}
		}
		catch (IOException e)
		{
