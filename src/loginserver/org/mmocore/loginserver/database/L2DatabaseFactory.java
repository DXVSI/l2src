package org.mmocore.loginserver.database;
...
public class L2DatabaseFactory extends BasicDataSource
{
	...
	{
		super(Config.DATABASE_DRIVER, Config.DATABASE_URL, Config.DATABASE_LOGIN, Config.DATABASE_PASSWORD, Config.DATABASE_MAX_CONNECTIONS, Config.DATABASE_MAX_CONNECTIONS,
