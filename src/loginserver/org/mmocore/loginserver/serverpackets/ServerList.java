package org.mmocore.loginserver.serverpackets;
...
public final class ServerList extends L2LoginServerPacket
{
	...
	public ServerList(Account account)
	{
		...
		for (GameServer gs : GameServerManager.getInstance().getGameServers())
		{
			...
			_servers.add(new ServerData(gs.getId(), ip, gs.getPort(), gs.isPvp(), gs.isShowingBrackets(), gs.getServerType(), gs.getOnline(), gs.getMaxPlayers(), gs.isOnline(), entry == null ? 0
			        : entry.getKey(), gs.getAgeLimit(), entry == null ? ArrayUtils.EMPTY_INT_ARRAY : entry.getValue()));
		}
	}
